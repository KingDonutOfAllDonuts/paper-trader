...
import { calculateBalance, calculateTodaysEarning, formatNumber } from '@renderer/store/utils'
...
const AccountList = () => {
  ...
  return (
    <div className='flex flex-col flex-1 rounded-md border-2 m-5 border-zinc-700 overflow-y-auto custom-scrollbar'>
